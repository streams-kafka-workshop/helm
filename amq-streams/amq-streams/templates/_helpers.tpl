...
app.kubernetes.io/name: {{ include "amq-streams.name" . }}
...
*/}}
{{- define "amq-streams.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "amq-streams.fullname" .) .Values.serviceAccount.name }}
{{- else }}
