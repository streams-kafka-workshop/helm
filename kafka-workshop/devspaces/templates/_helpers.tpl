...
ArgoCD Syncwave
*/}}
{{- define "devspaces.devspaces.argocd-syncwave" -}}
{{- if .Values.argocd }}
{{- if and (.Values.argocd.devspaces) (.Values.argocd.devspaces.syncwave) (.Values.argocd.enabled) -}}
argocd.argoproj.io/sync-wave: "{{ .Values.argocd.devspaces.syncwave }}"
{{- else }}
{{- "{}" }}
{{- end }}
{{- else }}
